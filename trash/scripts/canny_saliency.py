...
while True:
    ...
    saliencyMap = cv2.resize(saliencyMap, (saliencyMap.shape[1] - 200, saliencyMap.shape[0] - 200))
    threshMap = cv2.Canny(saliencyMap, 10, 255, L2gradient=True)
    threshMap = cv2.resize(threshMap, (threshMap.shape[1] + 200, threshMap.shape[0] + 200), interpolation=cv2.INTER_AREA)
